...
## This is a Segment wrapper for AppsFlyer SDK that is built with iOS SDK v6.0.5. 
...
**Production** version: 
```ruby
pod 'segment-appsflyer-ios', '6.0.5'
```

**Strict mode SDK** version: 
```ruby
pod 'segment-appsflyer-ios/Strict', '6.0.5'
```
...
**Production** version: 
```ogdl
github "AppsFlyerSDK/segment-appsflyer-ios" "6.0.5"
```
