Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/af-margot/segment-appsflyer-ios-qa.git", :tag => s.version.to_s }
  ...
  s.subspec 'Main' do |ss|
    ss.ios.dependency 'AppsFlyerFramework', '~> 6.0.5'
    ss.tvos.dependency 'AppsFlyerFramework', '~> 6.0.5'
  end
  
  s.subspec 'Strict' do |ss|
    ss.ios.dependency 'AppsFlyerFramework/Strict', '~> 6.0.5'
  end

  s.subspec 'MacCatalyst' do |ss|
    ss.ios.dependency 'AppsFlyerFramework/MacCatalyst', '~> 6.0.5'
  end
end
